        ...
        <>
                ...
                <nav className="bg-white border-gray-200 px-4 lg:px-6 py-2.5 shadow-md shadow-gray-500 dark:bg-gray-800 fixed z-50 w-screen">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        <a href="#" className="flex items-center">
                            <img src="../src/assets/logo.jpg" className="mr-3 h-12 sm:h-14" alt="Flowbite Logo" />
                            <span className="self-center text-xl font-semibold whitespace-nowrap dark:text-white"></span>
                        </a>
                        <div className="flex items-center lg:order-2">
                            <a href="#contact" className="bg-indigo-500 text-gray-100 shadow-sm shadow-black dark:text-white hover:bg-gray-50 focus:ring-4 focus:ring-gray-300 font-medium rounded-lg text-sm px-4 lg:px-5 py-2 lg:py-2.5 mr-2 dark:hover:bg-gray-700 focus:outline-none dark:focus:ring-gray-800 hidden xs:block">Buchen Sie jetzt</a>
            ...
            {navbarOpen ? (
                <div className="bg-black/50 h-screen flex items-center justify-center fixed z-50 w-screen">
                    <div className="flex pt-16 bg-gray-100 w-3/4 h-1/2 rounded-xl relative flex-col">
                        ...
                        <ul className="flex flex-col mt-4 font-medium items-center">
                            <li>
                                <a
                                    ...
                                    href="#"
                                    className="block py-2 pr-4 pl-3 text-xl font-bold text-gray-700 rounded bg-primary-700 lg:bg-transparent lg:text-primary-700 lg:p-0 dark:text-white"
                                    aria-current="page"
                                >
                                    Home
                                </a>
                            ...
                            <li>
                                <a
                                    onClick={() => setNavbarOpen(false)}
                                    href="#ausstattung"
                                    className="block py-2 pr-4 pl-3 text-xl font-bold text-gray-700 border-b border-gray-100 hover-bg-gray-50 lg-hover-bg-transparent lg-border-0 lg-hover-text-primary-700 lg-p-0 dark-text-gray-400 lg-dark-hover-text-white dark-hover-bg-gray-700 dark-hover-text-white lg-dark-hover-bg-transparent dark-border-gray-700"
                                >
                                    Ausstattung
                                </a>
                            </li>
