...
export default function Navbar() {
    ...
    const navbar: ButtonElement | null =
        document.getElementById("hide-navbar");
    ...
    return (
        <>
            <header id="" className="">
                <nav className="bg-transparent fixed px-4 lg:px-6 py-2.5 dark:bg-gray-800 z-50 w-screen">
                    <div className="flex flex-wrap justify-between items-center mx-auto max-w-screen-xl">
                        <a href="#" className="flex items-center" id="">
                        ...
                        <div className="flex items-center lg:order-2">
                            ...
                            <button onClick={() => setNavbarOpen(true)} data-collapse-toggle="mobile-menu-2" type="button" className="inline-flex items-center p-2 ml-1 text-sm text-gray-900 rounded-lg lg:hidden hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-gray-200 dark:text-gray-400 dark:hover:bg-gray-700 dark:focus:ring-gray-600" aria-controls="mobile-menu-2" aria-expanded="false">
